...
public class AutomationDriverSpecializedScreenRecorder extends ScreenRecorder {
 
    private String name;
 
    public AutomationDriverSpecializedScreenRecorder(GraphicsConfiguration cfg,
